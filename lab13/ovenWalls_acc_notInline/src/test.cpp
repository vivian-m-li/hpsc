...
int main(int argc, char *argv[])
{
  ...
  // ADDED
  // Moved data transfer outside the loop (have it only occur once)
...
// Commened out and moved above   StartTimer(t0);
//#pragma acc enter data copyin( coordB[ 0:nFieldB+1 ][0:3], faceB[ 0:nFacesB+1 ][0:5], normalB[ 0:nFacesB+1 ][0:3], blocked [ 0:nFacesB+1 ] , Ray[ 0:3], Ray0 [ 0:3] )

// Commented out - this line specifies a lot of variables over each iteration of the loop
